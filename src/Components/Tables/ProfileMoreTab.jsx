...
import {
   Icon28Profile,Icon28WriteOutline, Icon28CopyOutline, Icon28LinkCircleOutline, Icon28ArchiveOutline,Icon28StatisticsOutline
} from "@vkontakte/icons";
import style from "./Tables.module.css";

const ProfileMoreTab = () => {
   const list = [
      ...
      { id: 4, text: "Поделиться с профилем", iconLeft: <Icon28LinkCircleOutline /> },
      {
        id: 5,
        text: "Архив историй",
        iconLeft: <Icon28ArchiveOutline/>,
      },
      { id: 6, text: "Статистика профиля", iconLeft: <Icon28StatisticsOutline/> },
    ];
